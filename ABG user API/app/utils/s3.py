...
#
#         # Object exists, proceed with downloading
...
#         else:
#             print(f"Error checking or downloading file from S3: {str(e)}")
#
#         return None
...
#         client.put_object(Bucket=bucket_name, Key=file.filename, Body=file, ContentType=file.content_type)
#
